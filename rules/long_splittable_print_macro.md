...
# `perfectionist::long_splittable_print_macro`

**Default state:** `active`  
**Source:** [`src/rules/long_splittable_print_macro.rs`](../src/rules/long_splittable_print_macro.rs)
...
Configure via `dylint.toml` under `["perfectionist::long_splittable_print_macro"]`. Every field is optional; the per-field prose below states the default.
