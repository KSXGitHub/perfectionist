...
# `perfectionist::needless_borrowed_parameter`

**Default state:** `active`  
**Source:** [`src/rules/needless_borrowed_parameter.rs`](../src/rules/needless_borrowed_parameter.rs)
...
Configure via `dylint.toml` under `["perfectionist::needless_borrowed_parameter"]`. Every field is optional; the per-field prose below states the default.
