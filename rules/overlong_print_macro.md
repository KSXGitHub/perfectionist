...
# `perfectionist::overlong_print_macro`

**Default state:** `active`  
**Source:** [`src/rules/overlong_print_macro.rs`](../src/rules/overlong_print_macro.rs)
...
Configure via `dylint.toml` under `["perfectionist::overlong_print_macro"]`. Every field is optional; the per-field prose below states the default.
