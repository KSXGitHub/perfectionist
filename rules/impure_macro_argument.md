...
**Source:** [`src/rules/impure_macro_argument.rs`](../src/rules/impure_macro_argument.rs)
...
Configure via `dylint.toml` under `["perfectionist::impure_macro_argument"]`. Every field is optional; the per-field prose below states the default.
