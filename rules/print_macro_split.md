...
# `perfectionist::print_macro_split`

**Default state:** `active`  
**Source:** [`src/rules/print_macro_split.rs`](../src/rules/print_macro_split.rs)
...
Configure via `dylint.toml` under `["perfectionist::print_macro_split"]`. Every field is optional; the per-field prose below states the default.
