...
//! `thiserror_usage`: the empty [`Config`] shape, the
//! recognised `thiserror` paths, the [`ThiserrorUsage`]
...
const CONFIG_KEY: &str = "perfectionist::thiserror_usage";
...
pub(super) struct ThiserrorUsage {
