...
use config::ImpureMacroArguments;
use late::ImpureMacroArgumentsLate;
...
declare_tool_lint! {
    ...
    /// ```
    pub perfectionist::IMPURE_MACRO_ARGUMENTS,
    Warn,
...
pub fn register_pass(lint_store: &mut LintStore) {
    ...
    lint_store.register_pre_expansion_lint_pass(Box::new(|| Box::new(ImpureMacroArguments::new())));
...
impl EarlyLintPass for ImpureMacroArguments {
