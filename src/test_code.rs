...
/// Whether the item `def_id` is test code under either reading: the
/// whole crate is rooted in `tests/` or `benches/` (see
/// [`crate::cargo_target`]), or the item sits in test-exclusive code
/// per [`in_test_code`].
