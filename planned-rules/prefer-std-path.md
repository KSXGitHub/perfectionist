...
is the `prefer_std` counterpart they have no equivalent for. (This rule
once carried both directions under a mandatory `style` knob; the
`prefer_core` half was dropped as a duplicate of the two clippy lints —
see <https://github.com/KSXGitHub/perfectionist/issues/256>.)
